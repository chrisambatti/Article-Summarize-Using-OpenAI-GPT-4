...
1. <h1>Open the project in vscode and open terminal and type the command to install the packages</h1>
   <h2> npm install</h2>
2. <h1>Run this command to run the project on local server</h1>
3. <h2>npm run dev</h2>
